 ...
 * @Test
 * void
 * givenCorrectAnswerCountAndTotalQuestionCount_callCalculateTestResult_returnTotalMark
 * () {
 ...
 * @Test
 * void
 * givenZeroCorrectAnswerCountAndTotalQuestionCount_callCalculateTestResult_returnTotalMark
 * () {
 * PracticeService practiceService = new PracticeService();
 ...
 * @Test
 * void
 * givenZeroCorrectAnswerCountAndZeroTotalQuestionCount_callCalculateTestResult_returnTotalMark
 * () {
 * PracticeService practiceService = new PracticeService();
